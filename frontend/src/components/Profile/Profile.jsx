  ...
  return (
    <Stack flexDirection={'column'} sx={{width:'225px',height:'max-content' ,backgroundColor:'#FFFFFF'}} >
        <Stack flexDirection={'column'} >
             <Box  > <img src={backgroundimg} alt='' style={{width:225 , height:56 ,borderRadius:10, borderBottomLeftRadius:0 ,
               borderBottomRightRadius:0 ,background:'skyblue' }}></img></Box>
             <Box    sx={{ display:'flex' , ml:'78.5px' , mt:'-38px' , mb:'12px' }} >
               <img src={backgroundimg} alt='' style={{width:68 , height:68 ,background:'black', borderRadius:'50%' }}>
                </img></Box>
        </Stack >
